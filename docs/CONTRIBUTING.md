...
- 破壊的または大規模な変更になりそうだったら事前に [Issue](https://github.com/revati-jp/website-dev/issues) 立てた方が賢明。
- 何かわからないことがあれば [Discussions](https://github.com/revati-jp/website-dev/discussions) なりで気軽に質問してください。